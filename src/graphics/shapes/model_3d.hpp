...
namespace graphics::shapes
{
    ...
    public:
        ...
        virtual void Scale(const math::Vector &center, const math::Vector &scale_vector);
        ...
        virtual void Rotate(const math::Vector &center, math::Vector &radians);
        ...
        virtual void Transform(const math::Vector &center, const math::Vector &scale, const math::Vector &radians);
